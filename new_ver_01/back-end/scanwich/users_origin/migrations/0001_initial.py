    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('u_verif', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('u_id', models.CharField(max_length=150, unique=True)),
                ('t_key', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('t_date', models.DateTimeField(auto_now_add=True)),
                ('t_limit', models.DateTimeField(default=datetime.datetime(2023, 9, 21, 13, 5, 9, 343188, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
