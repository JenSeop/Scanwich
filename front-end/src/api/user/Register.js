...
//   height: '20px',
//   backgroundColor:
//     theme.palette.mode === 'light' ? grey[100] : theme.palette.background.default, // 양옆
// }));
...
/* --------- */
  ...
  React.useEffect(() => {
    ...
    // 이곳에 렌더링 후에 실행되어야 하는 코드를 작성합니다.
    document.querySelector('.App').style.backgroundColor = '#373531';
    const rootElement = document.getElementById('root');
    if (rootElement) {
      rootElement.style.boxSizing = 'content-box'
    }
  ...
  }, []); // 빈 배열은 의존성 배열로, 여기에 의존성이 있는 상태나 프롭스가 있다면 변경될 때마다 useEffect가 실행됩니다.
